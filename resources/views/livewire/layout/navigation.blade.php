            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('manage')" wire:navigate>
                            Manage
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('search')" wire:navigate>
                            Search
                        </x-dropdown-link>
                        <!-- Authentication -->
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('manage')" wire:navigate>
                    Manage
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('search')" wire:navigate>
                    Search
                </x-responsive-nav-link>
